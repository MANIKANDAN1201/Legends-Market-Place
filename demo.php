...
<div class="col-sm-6 col-md-3 col-lg-3">
  ...
  <div class="container-fluid text-center" id="new">
    ...
    <!-- <div class="row">
        ...
        <div class="col-sm-4 text-center artifact-block">
            <img class="block-center img-responsive" src="img/artifacts/1.jpg" >
            <hr>
            Artifact 1 <br>
            Rs 500  &nbsp
            <span style="text-decoration:line-through;color:#828282;"> 435 </span>
        ...
        <div class="col-sm-4 text-center artifact-block">
            <img class="img-responsive" src="img/artifacts/2.jpg" style="width: 100%;height: 300px;">
            <hr>
            Artifact 2 <br>
            Rs 800  &nbsp
            <button class="btn btn-primary btn-sm">Add to Cart</button>
        ...
        <div class="col-sm-4 text-center artifact-block">
            <img class="img-responsive" src="img/artifacts/3.jpg" style="width: 100%;height: 300px;">
            <hr>
            Artifact 3 
            Rs 1000  &nbsp
            <button class="btn btn-primary btn-sm">Add to Cart</button> -->
